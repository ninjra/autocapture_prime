...
PLUGIN_OPTION_PATHS: dict[str, list[str]] = {
    "builtin.capture.windows": [
        ...
        "capture.video.activity.enabled",
        "capture.video.activity.active_fps",
        "capture.video.activity.idle_fps",
        "capture.video.activity.active_bitrate_kbps",
        "capture.video.activity.idle_bitrate_kbps",
        "capture.video.activity.active_jpeg_quality",
        "capture.video.activity.idle_jpeg_quality",
        ...
        "capture.video.dedupe.sample_bytes",
    ...
    "builtin.processing.sst.uia_context": [
        "plugins.settings.builtin.processing.sst.uia_context.dataroot",
        "plugins.settings.builtin.processing.sst.uia_context.allow_latest_snapshot_fallback",
        "plugins.settings.builtin.processing.sst.uia_context.require_hash_match",
        "plugins.settings.builtin.processing.sst.uia_context.max_focus_nodes",
        "plugins.settings.builtin.processing.sst.uia_context.max_context_nodes",
        "plugins.settings.builtin.processing.sst.uia_context.max_operable_nodes",
        "plugins.settings.builtin.processing.sst.uia_context.drop_offscreen",
        "processing.sst.stage_providers.index.text.enabled",
        "processing.sst.stage_providers.index.text.provider_ids",
        "processing.sst.stage_providers.index.text.fanout",
        "processing.sst.stage_providers.index.text.max_providers",
    ...
    "builtin.sst.preprocess.normalize": [
        ...
        "processing.sst.stage_providers.preprocess.normalize.fanout",
        "processing.sst.stage_providers.preprocess.normalize.max_providers",
        "processing.sst.strip_alpha",
        "processing.sst.phash_size",
        "processing.sst.phash_downscale",
    ],
    ...
    "builtin.sst.ocr.onnx": [
        ...
        "processing.sst.ocr_nms_iou_bp",
        "processing.sst.ocr_max_tokens",
        "processing.sst.ocr_max_patches",
    ],
    "builtin.sst.layout.assemble": [
        ...
        "processing.sst.stage_providers.layout.assemble.fanout",
        "processing.sst.stage_providers.layout.assemble.max_providers",
        "processing.sst.layout_line_y_px",
        "processing.sst.layout_block_gap_px",
        "processing.sst.layout_align_tol_px",
    ],
    "builtin.sst.extract.table": [
        ...
        "processing.sst.table_min_rows",
        "processing.sst.table_min_cols",
        "processing.sst.table_max_cells",
        "processing.sst.table_row_gap_px",
        "processing.sst.table_col_gap_px",
    ],
    "builtin.sst.extract.spreadsheet": [
        ...
        "processing.sst.stage_providers.extract.spreadsheet.fanout",
        "processing.sst.stage_providers.extract.spreadsheet.max_providers",
        "processing.sst.sheet_header_scan_rows",
    ],
    ...
    "builtin.sst.extract.chart": [
        ...
        "processing.sst.stage_providers.extract.chart.fanout",
        "processing.sst.stage_providers.extract.chart.max_providers",
        "processing.sst.chart_min_ticks",
    ],
    "builtin.sst.ui.parse": [
        ...
        "processing.sst.stage_providers.ui.parse.fanout",
        "processing.sst.stage_providers.ui.parse.max_providers",
        "processing.sst.ui_parse.enabled",
        "processing.sst.ui_parse.mode",
        "processing.sst.ui_parse.max_providers",
        "processing.sst.ui_parse.fallback_detector",
    ],
    "builtin.sst.track.cursor": [
        ...
        "processing.sst.stage_providers.track.cursor.fanout",
        "processing.sst.stage_providers.track.cursor.max_providers",
        "processing.sst.cursor_detect.enabled",
        "processing.sst.cursor_detect.threshold",
        "processing.sst.cursor_detect.stride_px",
        "processing.sst.cursor_detect.scales",
        "processing.sst.cursor_detect.downscale",
    ],
    ...
    "builtin.sst.temporal.segment": [
        "processing.sst.stage_providers.temporal.segment.enabled",
        "processing.sst.stage_providers.temporal.segment.provider_ids",
        "processing.sst.stage_providers.temporal.segment.fanout",
        "processing.sst.stage_providers.temporal.segment.max_providers",
        "processing.sst.temporal_segment.mode",
        "processing.sst.d_stable",
        "processing.sst.d_boundary",
        "processing.sst.diff_threshold_bp",
        "processing.sst.segment_downscale_px",
    ],
    "builtin.sst.build.delta": [
        ...
        "processing.sst.stage_providers.build.delta.fanout",
        "processing.sst.stage_providers.build.delta.max_providers",
        "processing.sst.delta_bbox_shift_px",
        "processing.sst.delta_table_match_iou_bp",
    ],
    ...
    "builtin.sst.compliance.redact": [
        ...
        "processing.sst.stage_providers.compliance.redact.max_providers",
        "processing.sst.redact_enabled",
        "processing.sst.redact_denylist",
    ],
    "builtin.sst.persist": [
        "processing.sst.stage_providers.persist.bundle.enabled",
        "processing.sst.stage_providers.persist.bundle.provider_ids",

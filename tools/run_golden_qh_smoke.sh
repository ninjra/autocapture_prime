...
.venv/bin/python tools/run_advanced10_queries.py --report "$latest_report" --repro-runs 1 --lock-retries 1 --query-timeout-s "$query_timeout_s" --output artifacts/advanced10/advanced20_post_patch_smoke.json

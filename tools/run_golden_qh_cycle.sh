...
export AUTOCAPTURE_VLM_PREFLIGHT_COMPLETION_TIMEOUT_S="${AUTOCAPTURE_VLM_PREFLIGHT_COMPLETION_TIMEOUT_S:-45}"
...
export AUTOCAPTURE_VLM_PREFLIGHT_RETRIES="${AUTOCAPTURE_VLM_PREFLIGHT_RETRIES:-6}"

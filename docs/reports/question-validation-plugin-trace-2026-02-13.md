...
- Generated: `2026-02-19T17:00:05.919606Z`
- Artifact: `artifacts/advanced10/advanced20_strict_latest.json`
- Run report: `artifacts/single_image_runs/single_20260219T042145Z/report.json`
...
| --- | ---: | ---: | --- | ---: | --- | --- | ---: |
| Q1 | True | True | ok | 0.93 | high | classic | 3 |
| Q2 | True | True | ok | 0.93 | high | classic | 3 |
| Q3 | True | True | ok | 0.93 | high | classic | 3 |
| Q4 | True | True | ok | 0.93 | high | classic | 4 |
| Q5 | True | True | ok | 0.93 | high | classic | 3 |
| Q6 | True | True | ok | 0.93 | high | classic | 3 |
| Q7 | True | True | ok | 0.93 | high | classic | 3 |
| Q8 | True | True | ok | 0.93 | high | state | 4 |
| Q9 | True | True | ok | 0.93 | high | classic | 3 |
| Q10 | True | True | ok | 0.93 | high | classic | 3 |
| H1 | True | True | ok | 0.93 | high | state | 3 |
| H2 | True | True | ok | 0.93 | high | classic | 3 |
| H3 | True | True | ok | 0.93 | high | classic | 3 |
...
| H9 | True | True | ok | 0.93 | high | classic | 3 |
| H10 | True | True | ok | 0.93 | high | classic | 3 |
...
| builtin.observation.graph | loaded | 17 | 3 | 17 | 0 | 0 | 0.9300 | +0.0000 | 0.000 | neutral |
| builtin.processing.sst.pipeline | loaded | 2 | 18 | 2 | 0 | 0 | 0.9300 | +0.0000 | 0.000 | neutral |
...
| hard_vlm.direct | seen_in_path_only | 20 | 0 | 20 | 0 | 0 | 0.9300 | +0.0000 | 0.000 | neutral |
| capture.evidence | seen_in_path_only | 2 | 18 | 2 | 0 | 0 | 0.9300 | +0.0000 | 0.000 | neutral |
...
- Plugins in answer path:
  ...
  - `builtin.answer.synth_vllm_localhost` | contribution_bp=0 | claim_count=0 | citation_count=0 | est_latency_ms=0
  - `hard_vlm.direct` | contribution_bp=0 | claim_count=4 | citation_count=1 | est_latency_ms=0
...
- Plugins in answer path:
  ...
  - `builtin.processing.sst.pipeline` | contribution_bp=3333 | claim_count=1 | citation_count=1 | est_latency_ms=0
  - `builtin.answer.synth_vllm_localhost` | contribution_bp=0 | claim_count=0 | citation_count=0 | est_latency_ms=0
  - `hard_vlm.direct` | contribution_bp=0 | claim_count=3 | citation_count=1 | est_latency_ms=0
...
- Plugins in answer path:
  ...
  - `builtin.answer.synth_vllm_localhost` | contribution_bp=0 | claim_count=0 | citation_count=0 | est_latency_ms=0
  - `hard_vlm.direct` | contribution_bp=0 | claim_count=2 | citation_count=1 | est_latency_ms=0
...
- Plugins in answer path:
  ...
  - `capture.evidence` | contribution_bp=5000 | claim_count=1 | citation_count=1 | est_latency_ms=0
  - `builtin.answer.synth_vllm_localhost` | contribution_bp=0 | claim_count=0 | citation_count=0 | est_latency_ms=0
  - `hard_vlm.direct` | contribution_bp=0 | claim_count=1 | citation_count=1 | est_latency_ms=0
...
- Confidence: `0.93` (high)
- Plugins in answer path:
  - `builtin.processing.sst.pipeline` | contribution_bp=10000 | claim_count=1 | citation_count=1 | est_latency_ms=0
  - `builtin.answer.synth_vllm_localhost` | contribution_bp=0 | claim_count=0 | citation_count=0 | est_latency_ms=0
  - `hard_vlm.direct` | contribution_bp=0 | claim_count=1 | citation_count=1 | est_latency_ms=0
